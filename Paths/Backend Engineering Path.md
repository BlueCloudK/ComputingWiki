...
- [[Application Service]] — điều phối use case ở tầng application.
...
- [[Domain Service]] — giữ logic nghiệp vụ không thuộc một entity cụ thể.
...
- [[Request Context]] — giữ user/trace/tenant/deadline đi qua request.
