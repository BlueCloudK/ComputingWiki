...
Aliases: software development life cycle model, mô hình vòng đời phần mềm

Type: Artifact / Diagram

## Bản chất

Software Life Cycle Model là artifact dùng để nhìn thấy cấu trúc, luồng hoặc quan hệ mà đọc code/tài liệu chữ khó thấy. Giá trị của nó nằm ở việc làm rõ boundary, actor, component, data flow hoặc state chứ không phải vẽ cho đẹp. Nó nối với nhóm quyết định quanh software life cycle model.

## Dùng trong dự án để làm gì

Software Life Cycle Model giúp team thống nhất hình dung trước khi sửa architecture, API, database hoặc workflow. Nó là output để review quyết định, phát hiện dependency ẩn và onboarding người mới nhanh hơn.
...
- Software Modeling and Design Map / Ch03
