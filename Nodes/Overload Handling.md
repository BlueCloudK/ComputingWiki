...
Aliases: overload handling, xử lý quá tải

Type: Reliability / SRE

## Bản chất

Overload Handling tập trung vào việc service tiếp tục đáp ứng kỳ vọng qua thời gian, kể cả khi có lỗi, tải tăng hoặc deploy thay đổi. Nó gắn reliability với SLO, error budget, monitoring, incident response và postmortem. Nó nối với các phần liên quan như [[Load]], [[Scalability]], [[Capacity Planning]] và nhóm quyết định quanh overload handling.

## Dùng trong dự án để làm gì

Overload Handling giúp team quyết định khi nào ưu tiên feature, khi nào dừng để giảm risk vận hành. Trong dự án, nó biến 'ổn định' thành tín hiệu đo được và quy trình phản ứng khi service degrade.
