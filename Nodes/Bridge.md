...
Bridge xuất hiện trong codebase khi team phải chia trách nhiệm, dependency, interface hoặc biến thể behavior. Nó nằm gần refactor, testability và maintainability.

## Boundary / Ranh giới

### Nó là gì

Bridge là cách tổ chức code để một phần thay đổi không kéo theo quá nhiều phần khác.
...
Bridge tách abstraction khỏi implementation để hai chiều thay đổi độc lập thay vì nhân số class theo mọi tổ hợp.
