...
Software Architecture Concept xuất hiện khi cấu trúc, flow, state hoặc relationship cần được nhìn thấy thay vì chỉ đọc chữ/code. Nó thường hỗ trợ architecture review, requirement clarification hoặc onboarding.

## Boundary / Ranh giới

### Nó là gì

Software Architecture Concept là artifact biểu diễn một góc nhìn cụ thể của hệ thống để hỗ trợ quyết định.
...
Software Architecture Concept giúp team review dependency, data flow, state transition, actor/system boundary hoặc deployment shape trước khi implement lớn.
