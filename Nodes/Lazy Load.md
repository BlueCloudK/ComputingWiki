...
Lazy Load xuất hiện khi tốc độ, throughput, resource usage hoặc khả năng chịu tải ảnh hưởng tới user, cost hoặc reliability.

## Boundary / Ranh giới

### Nó là gì

Lazy Load là cách nhìn hệ thống qua metric và bottleneck thay vì cảm giác nhanh/chậm.
...
Lazy Load ảnh hưởng tới việc chọn index/cache/queue/scale/refactor và quyết định khi nào tối ưu là đáng làm.
