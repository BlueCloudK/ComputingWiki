...
Aliases: graph data model, mô hình dữ liệu graph

Type: Data / Database

## Context / Ngữ cảnh

Graph Data Model xuất hiện khi hệ thống cần lưu, truy vấn, migrate, kiểm soát consistency hoặc hiểu dữ liệu qua thời gian. Nó thường nằm trong database schema, data model, query path hoặc integration payload.

## Boundary / Ranh giới

### Nó là gì

Graph Data Model là một phần của cách dữ liệu được biểu diễn, ràng buộc, truy cập hoặc giữ đúng trong hệ thống.
...
Graph Data Model ảnh hưởng tới database design, query performance, migration, audit/history, backup và cách debug lỗi dữ liệu.
...
- [[Data Model]] vì nó ảnh hưởng trực tiếp tới dữ liệu và consistency
