...
Risk tập trung vào việc service tiếp tục đáp ứng kỳ vọng qua thời gian, kể cả khi có lỗi, tải tăng hoặc deploy thay đổi. Nó gắn reliability với SLO, error budget, monitoring, incident response và postmortem. Nó nối với các phần liên quan như [[Error Budget]], [[System Safety]].

## Dùng trong dự án để làm gì

Risk giúp team quyết định khi nào ưu tiên feature, khi nào dừng để giảm risk vận hành. Trong dự án, nó biến 'ổn định' thành tín hiệu đo được và quy trình phản ứng khi service degrade.
