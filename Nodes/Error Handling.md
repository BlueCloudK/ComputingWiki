...
Error Handling nằm ở boundary nơi client, backend, service hoặc third-party phải hiểu nhau bằng contract. Vấn đề chính không chỉ là gọi được, mà là request/response, validation, error format và compatibility có ổn định không. Nó nối với các phần liên quan như [[Logging]], [[Response]] và nhóm quyết định quanh error handling.

## Dùng trong dự án để làm gì

Error Handling quyết định cách các phần của hệ thống tích hợp, đổi version và debug lỗi mismatch. Trong dự án, nó giúp chốt contract trước khi nhiều team/client phụ thuộc vào nhau.
