...
Aliases: fundamental testing process, quy trình test nền tảng

Type: Testing / Verification

## Bản chất

Fundamental Test Process là cách kiểm tra một loại rủi ro cụ thể trong phần mềm: logic sai, tích hợp vỡ, regression, dữ liệu test lệch hoặc behavior không khớp expectation. Nó phải nói rõ bắt lỗi gì và ở test level nào. Nó nối với các phần liên quan như [[Test Planning]], [[Test Analysis]], [[Test Design]] và nhóm quyết định quanh fundamental test process.

## Dùng trong dự án để làm gì

Fundamental Test Process giúp chọn test data, test level, CI gate và regression suite để giảm lỗi trước khi release. Trong dự án, nó gắn code change với bằng chứng kiểm tra thay vì chỉ dựa vào cảm giác.
