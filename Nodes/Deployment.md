...
Deployment xuất hiện khi service có user thật và lỗi/downtime làm giảm trải nghiệm hoặc gây chi phí vận hành.

## Boundary / Ranh giới

### Nó là gì

Deployment là cách biến 'ổn định' thành metric, SLO, alert, runbook và postmortem/action item.
...
Deployment ảnh hưởng tới quyết định release, ưu tiên technical debt, incident response và automation giảm toil.
