...
Little Law xuất hiện khi tốc độ, throughput, resource usage hoặc khả năng chịu tải ảnh hưởng tới user, cost hoặc reliability.

## Boundary / Ranh giới

### Nó là gì

Little Law là cách nhìn hệ thống qua metric và bottleneck thay vì cảm giác nhanh/chậm.
...
Little Law ảnh hưởng tới việc chọn index/cache/queue/scale/refactor và quyết định khi nào tối ưu là đáng làm.
