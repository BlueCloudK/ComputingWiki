...
Aliases: testing definition, testing là gì

Type: Testing / Verification

## Bản chất

What Is Testing là cách kiểm tra một loại rủi ro cụ thể trong phần mềm: logic sai, tích hợp vỡ, regression, dữ liệu test lệch hoặc behavior không khớp expectation. Nó phải nói rõ bắt lỗi gì và ở test level nào. Nó nối với các phần liên quan như [[Test Process]], [[Static Testing]], [[Dynamic Testing]] và nhóm quyết định quanh what is testing.

## Dùng trong dự án để làm gì

What Is Testing giúp chọn test data, test level, CI gate và regression suite để giảm lỗi trước khi release. Trong dự án, nó gắn code change với bằng chứng kiểm tra thay vì chỉ dựa vào cảm giác.
