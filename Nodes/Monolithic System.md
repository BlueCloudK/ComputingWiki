...
Monolithic System xuất hiện ở tầng implementation hoặc runtime: OS, process, memory, file, environment, tool hoặc platform behavior.

## Boundary / Ranh giới

### Nó là gì

Monolithic System là chi tiết có thể ảnh hưởng trực tiếp tới cách code chạy trong môi trường thật.
...
Monolithic System giúp debug lỗi environment-specific, performance thấp tầng, concurrency, file/memory hoặc config lệch.
...
- [[Operating System Structure]] vì node này thường được kiểm tra cùng khi ra quyết định
