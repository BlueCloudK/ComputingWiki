...
Information Technology xuất hiện khi hệ thống cần encode, parse, truyền hoặc hiểu dữ liệu/giao tiếp giữa producer và consumer.

## Boundary / Ranh giới

### Nó là gì

Information Technology là quy ước compatibility: field/type/version/error behavior phải được hai bên hiểu giống nhau.
...
Information Technology ảnh hưởng tới API payload, message, config, log, network call hoặc storage format.
