...
Aliases: black-box testing, kiểm thử hộp đen

Type: Testing / Verification

## Bản chất

Black Box Testing là cách kiểm tra một loại rủi ro cụ thể trong phần mềm: logic sai, tích hợp vỡ, regression, dữ liệu test lệch hoặc behavior không khớp expectation. Nó phải nói rõ bắt lỗi gì và ở test level nào. Nó nối với các phần liên quan như [[Acceptance Testing]], [[System Testing]] và nhóm quyết định quanh black box testing.

## Dùng trong dự án để làm gì

Black Box Testing giúp chọn test data, test level, CI gate và regression suite để giảm lỗi trước khi release. Trong dự án, nó gắn code change với bằng chứng kiểm tra thay vì chỉ dựa vào cảm giác.
