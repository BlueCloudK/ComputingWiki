...
Unit of Work xuất hiện trong codebase khi team phải chia trách nhiệm, dependency, interface hoặc biến thể behavior. Nó nằm gần refactor, testability và maintainability.

## Boundary / Ranh giới

### Nó là gì

Unit of Work là cách tổ chức code để một phần thay đổi không kéo theo quá nhiều phần khác.
...
Unit of Work ảnh hưởng tới module boundary, unit test, refactor path và nơi business rule được đặt trong code.
