...
Virtual Memory xuất hiện ở tầng implementation hoặc runtime: OS, process, memory, file, environment, tool hoặc platform behavior.

## Boundary / Ranh giới

### Nó là gì

Virtual Memory là chi tiết có thể ảnh hưởng trực tiếp tới cách code chạy trong môi trường thật.
...
Virtual Memory giúp debug lỗi environment-specific, performance thấp tầng, concurrency, file/memory hoặc config lệch.
...
- [[Memory Management]] vì node này thường được kiểm tra cùng khi ra quyết định
