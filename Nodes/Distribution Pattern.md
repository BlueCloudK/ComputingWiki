...
Aliases: distribution pattern, mẫu phân tán

Type: Code Design / Pattern

## Bản chất

Distribution Pattern là cách tổ chức responsibility, dependency hoặc variation trong code. Nó chỉ có giá trị khi làm code dễ đổi, dễ test hoặc giảm coupling; nếu dùng vì tên pattern nghe hay thì thường làm code khó đọc hơn. Nó nối với các phần liên quan như [[Remote Facade]], [[Data Transfer Object]] và nhóm quyết định quanh distribution pattern.

## Dùng trong dự án để làm gì

Distribution Pattern ảnh hưởng tới module boundary, interface, testability và nơi đặt business logic. Trong dự án, nó giúp xử lý code đang phình, trùng logic hoặc phụ thuộc chéo giữa layer/object.
