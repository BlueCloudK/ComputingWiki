...
Request dùng khi nhiều phần mềm cần giao tiếp ổn định với nhau. Trong dự án, nó quyết định contract, dữ liệu vào ra, lỗi tích hợp và khả năng thay đổi giữa frontend, backend, service hoặc third-party.
