...
Builder xuất hiện trong codebase khi team phải chia trách nhiệm, dependency, interface hoặc biến thể behavior. Nó nằm gần refactor, testability và maintainability.

## Boundary / Ranh giới

### Nó là gì

Builder là cách tổ chức code để một phần thay đổi không kéo theo quá nhiều phần khác.
...
Builder gom quá trình dựng object phức tạp thành từng bước rõ ràng, tránh constructor dài và trạng thái khởi tạo khó đọc.
