...
CSRF xuất hiện ở boundary giữa client, backend, service nội bộ hoặc third-party. Nó thường liên quan tới endpoint, request/response, validation, auth boundary, timeout và error format.

## Boundary / Ranh giới

### Nó là gì

CSRF là phần làm rõ hai bên tích hợp phải gửi gì, nhận gì, xử lý lỗi ra sao và giữ compatibility thế nào khi một bên thay đổi.
...
CSRF ảnh hưởng tới API design, frontend/backend handoff, integration test, backward compatibility và debug lỗi giữa service.
