...
UML Notation xuất hiện khi cấu trúc, flow, state hoặc relationship cần được nhìn thấy thay vì chỉ đọc chữ/code. Nó thường hỗ trợ architecture review, requirement clarification hoặc onboarding.

## Boundary / Ranh giới

### Nó là gì

UML Notation là artifact biểu diễn một góc nhìn cụ thể của hệ thống để hỗ trợ quyết định.
...
UML Notation giúp team review dependency, data flow, state transition, actor/system boundary hoặc deployment shape trước khi implement lớn.
