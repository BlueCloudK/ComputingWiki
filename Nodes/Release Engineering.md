...
Aliases: release engineering, kỹ nghệ phát hành

Type: Reliability / SRE

## Bản chất

Release Engineering tập trung vào việc service tiếp tục đáp ứng kỳ vọng qua thời gian, kể cả khi có lỗi, tải tăng hoặc deploy thay đổi. Nó gắn reliability với SLO, error budget, monitoring, incident response và postmortem. Nó nối với các phần liên quan như [[Deployment]], [[Rollback]], [[Automation]] và nhóm quyết định quanh release engineering.

## Dùng trong dự án để làm gì

Release Engineering giúp team quyết định khi nào ưu tiên feature, khi nào dừng để giảm risk vận hành. Trong dự án, nó biến 'ổn định' thành tín hiệu đo được và quy trình phản ứng khi service degrade.
