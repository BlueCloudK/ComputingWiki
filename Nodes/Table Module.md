...
Table Module xuất hiện trong codebase khi team phải chia trách nhiệm, dependency, interface hoặc biến thể behavior. Nó nằm gần refactor, testability và maintainability.

## Boundary / Ranh giới

### Nó là gì

Table Module là cách tổ chức code để một phần thay đổi không kéo theo quá nhiều phần khác.
...
Table Module đặt business logic quanh một table hoặc record set, hợp với app data-centric nhưng yếu khi domain behavior phức tạp.
