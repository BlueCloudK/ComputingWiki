...
Parallel Organization xuất hiện ở mức system: component, service, boundary, dependency, deployment shape hoặc failure mode. Nó thường liên quan tới maintainability, scalability và ownership.

## Boundary / Ranh giới

### Nó là gì

Parallel Organization là quyết định về cấu trúc và ranh giới hệ thống: phần nào sở hữu dữ liệu, phần nào gọi phần nào, và hệ thống chịu lỗi/tăng tải ra sao.
...
Parallel Organization ảnh hưởng tới cách chia module/service, deploy, debug incident, scale và onboard người mới.
...
- Parallel Organization không rõ boundary làm ownership, dependency hoặc data/control flow bị đặt sai chỗ
