...
Data Mapper xuất hiện trong codebase khi team phải chia trách nhiệm, dependency, interface hoặc biến thể behavior. Nó nằm gần refactor, testability và maintainability.

## Boundary / Ranh giới

### Nó là gì

Data Mapper là cách tổ chức code để một phần thay đổi không kéo theo quá nhiều phần khác.
...
Data Mapper tách domain object khỏi database schema bằng mapper riêng, giảm coupling giữa model nghiệp vụ và persistence.
