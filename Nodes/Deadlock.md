...
Deadlock xuất hiện ở tầng implementation hoặc runtime: OS, process, memory, file, environment, tool hoặc platform behavior.

## Boundary / Ranh giới

### Nó là gì

Deadlock là chi tiết có thể ảnh hưởng trực tiếp tới cách code chạy trong môi trường thật.
...
Deadlock giúp debug lỗi environment-specific, performance thấp tầng, concurrency, file/memory hoặc config lệch.
...
- [[Mutex]] vì node này thường được kiểm tra cùng khi ra quyết định
- [[Scheduling]] vì node này thường được kiểm tra cùng khi ra quyết định
