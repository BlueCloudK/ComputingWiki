...
Network Management xuất hiện ở tầng implementation hoặc runtime: OS, process, memory, file, environment, tool hoặc platform behavior.

## Boundary / Ranh giới

### Nó là gì

Network Management là chi tiết có thể ảnh hưởng trực tiếp tới cách code chạy trong môi trường thật.
...
Network Management giúp debug lỗi environment-specific, performance thấp tầng, concurrency, file/memory hoặc config lệch.
...
- [[Monitoring]] vì node này thường được kiểm tra cùng khi ra quyết định
