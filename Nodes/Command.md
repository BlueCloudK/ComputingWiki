...
Command xuất hiện trong codebase khi team phải chia trách nhiệm, dependency, interface hoặc biến thể behavior. Nó nằm gần refactor, testability và maintainability.

## Boundary / Ranh giới

### Nó là gì

Command là cách tổ chức code để một phần thay đổi không kéo theo quá nhiều phần khác.
...
Command biến hành động thành object để queue, undo, log hoặc dispatch mà caller không cần biết receiver cụ thể.
