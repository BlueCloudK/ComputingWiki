...
Aliases: testing through SDLC, testing trong vòng đời phần mềm

Type: Testing / Verification

## Bản chất

Testing Throughout Software Life Cycle là cách kiểm tra một loại rủi ro cụ thể trong phần mềm: logic sai, tích hợp vỡ, regression, dữ liệu test lệch hoặc behavior không khớp expectation. Nó phải nói rõ bắt lỗi gì và ở test level nào. Nó nối với các phần liên quan như [[Component Testing]], [[Integration Testing]], [[System Testing]] và nhóm quyết định quanh testing throughout software life cycle.

## Dùng trong dự án để làm gì

Testing Throughout Software Life Cycle giúp chọn test data, test level, CI gate và regression suite để giảm lỗi trước khi release. Trong dự án, nó gắn code change với bằng chứng kiểm tra thay vì chỉ dựa vào cảm giác.
