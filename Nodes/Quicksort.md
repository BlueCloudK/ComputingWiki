...
Aliases: quick sort, sắp xếp nhanh

Type: Computer Foundation

## Context / Ngữ cảnh

Quicksort xuất hiện như nền tảng giúp hiểu correctness, complexity, data structure, algorithm hoặc mô hình tính toán phía dưới phần mềm.

## Boundary / Ranh giới

### Nó là gì

Quicksort là kiến thức nền để giải thích vì sao code chạy đúng, chậm, sai ở edge case hoặc không scale khi input tăng.
...
Quicksort ảnh hưởng tới lựa chọn thuật toán, cấu trúc dữ liệu, test edge case và debug lỗi performance/correctness.
...
- Chưa cần đào sâu Quicksort nếu input nhỏ, bounded và không ảnh hưởng trực tiếp tới correctness hoặc latency người dùng
...
- [[Divide and Conquer]] vì node này thường được kiểm tra cùng khi ra quyết định
...
- quick sort
- sắp xếp nhanh
- Quicksort learning keyword
- Quicksort debug keyword
- Quicksort design keyword
