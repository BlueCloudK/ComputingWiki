...
Domain Model là cách tổ chức responsibility, dependency hoặc variation trong code. Nó chỉ có giá trị khi làm code dễ đổi, dễ test hoặc giảm coupling; nếu dùng vì tên pattern nghe hay thì thường làm code khó đọc hơn. Nó nối với nhóm quyết định quanh domain model.

## Dùng trong dự án để làm gì

Domain Model ảnh hưởng tới module boundary, interface, testability và nơi đặt business logic. Trong dự án, nó giúp xử lý code đang phình, trùng logic hoặc phụ thuộc chéo giữa layer/object.
