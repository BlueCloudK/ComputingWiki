...
Aliases: ISA, tập lệnh

Type: Computer Foundation

## Context / Ngữ cảnh

Instruction Set xuất hiện như nền tảng giúp hiểu correctness, complexity, data structure, algorithm hoặc mô hình tính toán phía dưới phần mềm.

## Boundary / Ranh giới

### Nó là gì

Instruction Set là kiến thức nền để giải thích vì sao code chạy đúng, chậm, sai ở edge case hoặc không scale khi input tăng.
...
Instruction Set ảnh hưởng tới lựa chọn thuật toán, cấu trúc dữ liệu, test edge case và debug lỗi performance/correctness.
...
- Chưa cần đào sâu Instruction Set nếu input nhỏ, bounded và không ảnh hưởng trực tiếp tới correctness hoặc latency người dùng
...
- [[Processor]] vì node này thường được kiểm tra cùng khi ra quyết định
...
- ISA
- tập lệnh
- Instruction Set learning keyword
- Instruction Set debug keyword
- Instruction Set design keyword
