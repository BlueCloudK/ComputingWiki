...
Aliases: testing process, quy trình test

Type: Testing / Verification

## Bản chất

Test Process là cách kiểm tra một loại rủi ro cụ thể trong phần mềm: logic sai, tích hợp vỡ, regression, dữ liệu test lệch hoặc behavior không khớp expectation. Nó phải nói rõ bắt lỗi gì và ở test level nào. Nó nối với các phần liên quan như [[Fundamental Test Process]], [[Test Planning]], [[Test Analysis]] và nhóm quyết định quanh test process.

## Dùng trong dự án để làm gì

Test Process giúp chọn test data, test level, CI gate và regression suite để giảm lỗi trước khi release. Trong dự án, nó gắn code change với bằng chứng kiểm tra thay vì chỉ dựa vào cảm giác.
...
- Software Testing ISTQB Map / Ch01.2 / Ch05
- SWEBOK Map / testing chapter
