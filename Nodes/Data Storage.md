...
Data Storage là khái niệm xuất hiện trong source map của ComputingWiki và cần có node thật để graph không sinh unresolved link.

## Boundary / Ranh giới

### Nó là gì

Data Storage dùng để đặt tên một vùng kiến thức, artifact, activity hoặc decision trong nhóm Computing Foundations.
...
Cơ chế lõi là hiểu Data Storage đang mô tả boundary nào, tạo artifact gì, và giúp kiểm tra hoặc thiết kế phần nào của hệ thống.

## Project Role / Vai trò trong dự án

Data Storage giúp người đọc tra lại thuật ngữ từ source map, rồi nối sang các node chi tiết hơn trong project workflow.

## Output / Artifact nên có

- Note ngắn định nghĩa Data Storage
- Trace về source map nơi thuật ngữ xuất hiện
- Link tới node liên quan mạnh nếu đã có trong wiki

## Decision Checklist / Câu hỏi kiểm tra

- Data Storage thuộc vùng kiến thức nào trong ComputingWiki?
...
- Để Data Storage chỉ là ghost link làm graph view có node không tồn tại
