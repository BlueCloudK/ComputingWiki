...
Creational Pattern xuất hiện trong codebase khi team phải chia trách nhiệm, dependency, interface hoặc biến thể behavior. Nó nằm gần refactor, testability và maintainability.

## Boundary / Ranh giới

### Nó là gì

Creational Pattern là cách tổ chức code để một phần thay đổi không kéo theo quá nhiều phần khác.
...
Creational Pattern kiểm soát cách object được tạo khi constructor trực tiếp làm lộ lifecycle, dependency hoặc variant.
