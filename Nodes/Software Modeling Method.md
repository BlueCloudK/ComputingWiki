...
Aliases: modeling method, phương pháp mô hình hóa phần mềm

Type: Artifact / Diagram

## Bản chất

Software Modeling Method là artifact dùng để nhìn thấy cấu trúc, luồng hoặc quan hệ mà đọc code/tài liệu chữ khó thấy. Giá trị của nó nằm ở việc làm rõ boundary, actor, component, data flow hoặc state chứ không phải vẽ cho đẹp. Nó nối với các phần liên quan như [[Use Case Modeling]], [[Static Modeling]], [[Dynamic Interaction Modeling]] và nhóm quyết định quanh software modeling method.

## Dùng trong dự án để làm gì

Software Modeling Method giúp team thống nhất hình dung trước khi sửa architecture, API, database hoặc workflow. Nó là output để review quyết định, phát hiện dependency ẩn và onboarding người mới nhanh hơn.
