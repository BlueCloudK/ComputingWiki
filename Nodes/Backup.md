...
Backup nằm ở phần đưa hệ thống chạy đúng môi trường và giữ nó quan sát được. Nó liên quan tới environment, config, release, health check, log, rollback và troubleshooting khi có lỗi thật. Nó nối với các phần liên quan như [[Rollback]].

## Dùng trong dự án để làm gì

Backup giúp biến code thành service có thể deploy, monitor và phục hồi. Trong dự án, nó giảm rủi ro 'chạy máy tôi được' nhưng fail ở staging/production.
