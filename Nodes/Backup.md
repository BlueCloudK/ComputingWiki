...
Backup xuất hiện khi code cần chạy ổn định trong staging/production với environment, config, health check, log và rollback rõ ràng.

## Boundary / Ranh giới

### Nó là gì

Backup là phần biến code thành service vận hành được và troubleshoot được.
...
Backup ảnh hưởng tới release safety, incident response, troubleshooting và khả năng phục hồi khi deploy lỗi.
