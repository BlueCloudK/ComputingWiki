...
Network Security xuất hiện ở nơi hệ thống có asset cần bảo vệ: identity, permission, secret, dữ liệu nhạy cảm, input công khai hoặc boundary với third-party.

## Boundary / Ranh giới

### Nó là gì

Network Security là control hoặc vùng kiến thức giúp giảm khả năng misuse và giảm impact khi control fail.
...
Network Security ảnh hưởng tới auth flow, permission, validation, secret handling, logging/audit và failure response.
