...
Protocol Layer xuất hiện khi hệ thống cần encode, parse, truyền hoặc hiểu dữ liệu/giao tiếp giữa producer và consumer.

## Boundary / Ranh giới

### Nó là gì

Protocol Layer là quy ước compatibility: field/type/version/error behavior phải được hai bên hiểu giống nhau.
...
Protocol Layer ảnh hưởng tới API payload, message, config, log, network call hoặc storage format.
