...
Composite xuất hiện trong codebase khi team phải chia trách nhiệm, dependency, interface hoặc biến thể behavior. Nó nằm gần refactor, testability và maintainability.

## Boundary / Ranh giới

### Nó là gì

Composite là cách tổ chức code để một phần thay đổi không kéo theo quá nhiều phần khác.
...
Composite cho client xử lý object đơn và cây object qua cùng interface, hợp với cấu trúc phân cấp như UI, menu hoặc tree.
