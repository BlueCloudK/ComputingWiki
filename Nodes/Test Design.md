...
Aliases: test design, thiết kế test

Type: Testing / Verification

## Bản chất

Test Design là cách kiểm tra một loại rủi ro cụ thể trong phần mềm: logic sai, tích hợp vỡ, regression, dữ liệu test lệch hoặc behavior không khớp expectation. Nó phải nói rõ bắt lỗi gì và ở test level nào. Nó nối với các phần liên quan như [[Test Case]], [[Test Data]], [[Test Design Techniques]] và nhóm quyết định quanh test design.

## Dùng trong dự án để làm gì

Test Design giúp chọn test data, test level, CI gate và regression suite để giảm lỗi trước khi release. Trong dự án, nó gắn code change với bằng chứng kiểm tra thay vì chỉ dựa vào cảm giác.
