...
Aliases: test design techniques, kỹ thuật thiết kế test

Type: Testing / Verification

## Bản chất

Testing Techniques là cách kiểm tra một loại rủi ro cụ thể trong phần mềm: logic sai, tích hợp vỡ, regression, dữ liệu test lệch hoặc behavior không khớp expectation. Nó phải nói rõ bắt lỗi gì và ở test level nào. Nó nối với các phần liên quan như [[Test Design Techniques]], [[Black Box Testing]], [[White Box Testing]] và nhóm quyết định quanh testing techniques.

## Dùng trong dự án để làm gì

Testing Techniques là MOC để đi từ vùng kiến thức lớn xuống các node có thể dùng trong dự án. Nó không thay node chi tiết; nhiệm vụ của nó là gom các quyết định, artifact, checklist và rủi ro liên quan để bạn không đọc rời rạc.
