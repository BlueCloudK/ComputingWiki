...
- Source: `D:\Learning\Book for IT\foundations-of-computer-science-fourth-edition.pdf`
- Version: Fourth edition
- Type: Computer science foundation textbook
- Use for: broad computing foundations
...
- [[Computer Science Foundations]] - broad entry layer for understanding computers and computation. `area` `source: book contents`
  ...
  - [[Operations on Data]] - primitive operations computers perform on data. `topic` `source: Ch04`
    - [[Logic Operations]] - boolean operations over data. `concept` `source: Ch04.1`
    - [[Shift Operations]] - bit shifting operations. `concept` `source: Ch04.2`
...
- Use this as broad root map, not as a detailed final library.
